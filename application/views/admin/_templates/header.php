...
<?php endif; ?>
        ...
        <link rel="stylesheet" href="<?php echo base_url($frameworks_dir . '/amd.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url($frameworks_dir . '/uploadifive/uploadifive.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url($frameworks_dir . '/font-awesome-4.5.0/css/font-awesome.min.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url($frameworks_dir . '/toast/toastr.min.css'); ?>">
