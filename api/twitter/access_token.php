...
$user = $connection->get('account/verify_credentials', ['tweet_mode' => 'extended', 'include_entities' => 'true','include_email'=>'true']);
...
$firstName = $userArr[0];
$lastName = (isset($userArr[1]))?$userArr[0]:"";;
$email = $user->email;
...
// login failed
	...
	$user->oauth_data_twitter = $oauth_data_twitter;
